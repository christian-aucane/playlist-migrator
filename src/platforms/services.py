...
class PlatformService:
    ...
    Raises:
        AuthenticationError: If the user is not authenticated and authentication is needed.
    ...
    def __init__(self, platform, user=None):
        ...
        try:
            ...
            if self.user is not None:
                ...
                self.client.set_unauthenticated_client()
        except OAuthToken.DoesNotExist:
            raise PlatformService.AuthenticationError(f"User does not have an access token for {platform}.")
